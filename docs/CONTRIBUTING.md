# Contributing to Jedvek

Thank you for your interest in contributing to Jedvek! We welcome contributions,
...
```nginx
git clone https://github.com/YOUR_USERNAME/jedvek.git
```

#### 4. Keep your fork up to date with the main branch

```nginx
# Add the main Jedvek repo as upstream
git remote add upstream https://github.com/lignum-vitae/jedvek.git
# Get latest changes
git fetch upstream
# Verify your remotes
git remote
...
```nginx
# Gets latest changes from main Jedvek project if you've set up an upstream branch as detailed above
git fetch upstream
...
#### 10. Open a Pull Request (PR) from your branch to the main branch of the original Jedvek repository on GitHub
...
from multiple areas within the Jedvek crate.
...
By contributing to Jedvek, you agree that your contributions will be licensed
under the MIT License, as outlined in the [LICENSE](https://github.com/lignum-vitae/jedvek/blob/main/LICENSE)
file.
